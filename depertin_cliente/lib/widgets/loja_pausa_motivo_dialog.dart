...
/// Resultado do diálogo de motivo da pausa (gravar em Firestore).
...
/// Diálogo modal para escolher motivo da pausa e, se almoço, horário de volta.
Future<LojaPausaMotivoResult?> showLojaPausaMotivoDialog(
  BuildContext context, {
  Color accent = const Color(0xFF6A1B9A),
