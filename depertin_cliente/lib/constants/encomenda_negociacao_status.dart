...
/// Mantidos em snake_case para coincidir com Firestore.
abstract class EncomendaNegociacaoStatus {
  ...
  static const entradaAguardandoPagamento =
      'entrada_aguardando_pagamento';
  ...
  /// Cancelamento explícito até antes da entrada paga (UI + validação backend).
  ...
  static String rotuloPt(String status) {
    switch (status) {
      ...
      case propostaAceitaPendenteEntrada:
        return 'Proposta aceita — gere o pagamento da entrada';
      case entradaAguardandoPagamento:
