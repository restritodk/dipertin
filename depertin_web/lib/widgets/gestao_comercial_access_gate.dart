...
class _GestaoComercialAccessGateState extends State<GestaoComercialAccessGate> {
  ...
  Widget _buildConteudo(
    ...
    final bloqueioAdmin = AssinaturaGestaoComercialService.assinaturaBloqueioAdmin(
    ...
    final temAcesso = AssinaturaGestaoComercialService.lojistaTemAcessoGestaoComercial(
